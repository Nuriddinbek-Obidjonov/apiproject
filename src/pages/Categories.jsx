...
function Categories() {
  ...
  const token =
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2lkIjoiNTczNzkzNTUtZDNjYi00NzY1LTgwMGEtNDZhOTU1NWJiOWQyIiwidG9rZW5fdHlwZSI6ImFjY2VzcyIsImlhdCI6MTcxNzI1OTkxOSwiZXhwIjoxNzQ4Nzk1OTE5fQ.NZApBzV3gHG4vel-wbdHS29Z9eAp13w6ChrwjHJCwuM";
  ...
  return (
    <div>
      <div className="flex justify-between mb-[20px]">
        ...
        <button
          className="text-2xl text-white bg bg-[#1677ff] p-[7px_15px] rounded-[8px]"
                ...
                <td className="p-[16px_16px] border-b border-[#e5e7eb]">
                  <Popover
                    ...
                    onOpenChange={(newOpen) =>
                      handlePopoverOpenChange(newOpen, index)
                    }
                  >
                  ...
                  <button
                    className="text-white bg bg-[#1677ff] p-[8px_18px] rounded-[8px]"
      ...
      >
        <form onSubmit={createForm}>
          ...
          <div className="text-right">
            <button
              type="submit"
              className="text-white bg bg-[#1677ff] p-[10px_20px] rounded-[8px]"
            >
              Add Category
            </button>
          </div>
      ...
      >
        <form onSubmit={editCategory}>
          ...
          <div className="mb-[20px]">
            ...
            {data.images && (
              <img
                className="w-[100px] mt-[15px]"
                src={`${urlImage}${data.images}`}
                alt="Selected Image"
              />
            )}
          </div>
